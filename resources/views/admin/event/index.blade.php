...
@section('title', 'ACLC - ATS Admin - Alumni Events')
@section('content')
<style>
    .loader-overlay {
        position: fixed;
...
<div class="az-content-header d-block d-md-flex justify-content-between align-items-center">
    <div>
        ...
        <p class="mg-b-0">ACLC Alumni Event Management</p>
    </div>
...
<div class="az-content-body">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="mb-0">Alumni Event & Activities Listings</h6>
        </div>
            ...
            <table id="dataTable" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{!! Str::limit(strip_tags($event->description), 150) !!}</td>
                        ...
                        <td>
                            <button class="btn btn-dark btn-sm editEventBtn" data-id="{{ $event->id }}">
...
@include('modals.admin.event.add_edit')
@endsection
